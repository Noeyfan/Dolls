...
public class FirstPersonCharacter : MonoBehaviour
{
    ...
    public bool
            hasControl = true;
    [SerializeField]
    AudioClip[] footstepSoundsLeft;
    [SerializeField]
    AudioClip[] footstepSoundsRight;

    [SerializeField]
    AudioClip[] footstepSoundsLeftOnRig;
    [SerializeField]
    AudioClip[] footstepSoundsRightOnRig;

    [SerializeField]
    AudioClip[] footstepSoundsLeftBasement;
    [SerializeField]
    AudioClip[] footstepSoundsRightBasement;
